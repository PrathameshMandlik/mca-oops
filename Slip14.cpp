/*data-title="Slip oops_114: Given that an EMPLOYEE class contains following members: data members: Employee
*/
#include <iostream>
...
class Employee {
    int emp_num;
    string emp_name; // Use string instead of char array
    float emp_basic;
    float emp_da;
    float emp_it;
    float net_sal;
...
int main() {
    ...
    // Clear the screen (optional, works on Windows)
    system("cls");
